...
export function AppNav() {
  ...
  return (
    <header className="relative z-[60] border-b border-slate-800/80 bg-slate-950/85 backdrop-blur">
      <nav className="app-nav-bar mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6" aria-label="Main navigation">
        ...
        <div className="flex items-center gap-0 sm:gap-1">
          <div className="app-primary-navigation flex items-center gap-0 sm:gap-1">
